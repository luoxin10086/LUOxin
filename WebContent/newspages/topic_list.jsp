...
<div id="header">
  <div id="welcome">
    欢迎使用新闻管理系统！${pageContext.request.contextPath }</div>
  <div id="nav">
  ...
  <div id="opt_area">
    <ul class="classlist">
     <c:forEach items="${requestScope.list}" var="topic">
      <li> &#160;&#160;&#160;&#160; ${topic.tname} 
      	&#160;&#160;&#160;&#160; 
      <a href='${pageContext.request.contextPath }/topic.do?opr=modify&tid=${topic.tid}&tname=${topic.tname}'>修改</a> 
      	&#160;&#160;&#160;&#160;
      <a href='..//topics?opr=del&tid=${topic.tid}'>删除</a> </li>
     </c:forEach>
    </ul>
  </div>
</div>
