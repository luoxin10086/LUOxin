...
<div id="main">
  ...
  <div id="opt_area">
    ...
    <form action="${pageContext.request.contextPath }/news.do?opr=addNews" method="post" enctype="multipart/form-data">
      <p>
        <label> 主题 </label>
        <select name="ntid">
          <option value=""></option>
      ...
      <p>
        <label> 内容 </label>
        <textarea name="ncontent"  id="newscontent" class="ckeditor" cols="70" rows="10"></textarea>
      </p>
      <p>
        <label> 上传图片 </label>
